...
/* This class is used to accept and process the HTTP request that comes from the client and redirect 
 * the necessary information to appropriate JSP after storing it into the database
 */
@WebServlet("/register")
